...
export default {
    ...
    setup() {
        ...
        const getUser = async () => {
          const cookies = await axios.get('https://trada-server.onrender.com/api/auth/checkCookies', { withCredentials: true });
          console.log(cookies.data);
          if(cookies.data === true) {
            const res = await axios.get('https://trada-server.onrender.com/api/auth/user', { withCredentials: true })
            user.value = res.data;
            console.log(user);
          } else {
