      ...
      <div class="body flex flex-col w-3/5 h-full pb-3" v-if="loading === false">
        <Nav />
            ...
            <div class="top-tab flex flex-row items-center justify-end text-xs mt-7">
                ...
                <div class="font-semibold"><a :href="'/store/' + $route.params.id">View as Buyer</a></div>
            </div>
            ...
            <div class="store-details row-flex items-center p-5 sm:p-12 rounded-lg justify-between mt-7 max-h-fit">
                ...
                <div class="store-info h-full rounded col-flex p-6 content-center">
                    ...
                    <button class="self-center justify-self-end text-sm font-semibold w-4/5 h-12 rounded-lg mt-4" style="background: #F8C616;"><a :href="$router.currentRoute.value.path + '/new_product'">Add Product</a></button>
                </div>   
            </div>
            ...
            <div class="products col-flex items-center mt-7 w-full">
                <div class="featured w-full col-flex  mt-3">
                    <div class="info row-flex items-center justify-between w-full">
                        ...
                        <button v-if="products.length > 3"><div class="grid place-items-center btn-2">View All</div></button>
                    </div>
                    <div class="products-g row-flex w-full h-full items-center mt-5">
                        ...
                        <div class="product h-full text-center px-2" v-if="products.length < 3">
                            <div class="product-img rounded-lg grid place-items-center">
                                <a :href="$router.currentRoute.value.path + '/new_product'" class="cursor-pointer">
                                    <div class="w-full grid-center h-24" style="">
                                    ...
                                    <p class="w-full h-full grid-center rubik font-bold bg-zinc-500">Add Product</p>
                                </div>
                                </a>
                            </div>
                        </div>
...
export default {
    ...
    setup() {
        ...
        return {storeDetails, storePic, loading, products}
    }
}
</script>
